...
def display_nfl_schedule(request):
    ...
    # Convert to list and apply primetime filter
    ...
    # League selection - FIXED: members instead of users
    ...
    # FIXED: members instead of users
    ...
    for game in games:
        ...
        # These are now handled by the Game model properties:
        # - game.display_time_et
        # - game.is_primetime
        # - game.primetime_type (returns primetime_label)
        # - game.locked (same as is_locked)
        # - game.winner
        # - game.home_logo
        # - game.away_logo
